...
<ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                ...
                @if (auth()->user()->can('view-kategori-barang') ||
                        ...
                        auth()->user()->can('edit-kategori-barang') ||
                        auth()->user()->can('delete-kategori-barang'))
                    <li><a href="{{ url('backend/kategori-barang') }}" class="dropdown-item">Data Kategori Barang </a>
                    </li>
                @endif
    ...
    @if (auth()->user()->can('view-laporan-penjualan') ||
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                @if (auth()->user()->can('view-laporan-penjualan'))
                    <li><a href="{{ url('backend/laporan-penjualan') }}" class="dropdown-item">Laporan Penjualan</a>
                    </li>
                @endif

                @if (auth()->user()->can('view-laporan-penjualan-barang'))
                    <li><a href="{{ url('backend/laporan-penjualan-barang') }}" class="dropdown-item">Laporan Penjualan
                            Barang</a>
                    </li>
                @endif

                @if (auth()->user()->can('view-laporan-detail-penjualan'))
                    <li><a href="{{ url('backend/laporan-detail-penjualan') }}" class="dropdown-item">Laporan Detail
                            Penjualan</a>
                    </li>
                ...
                @if (auth()->user()->can('view-laporan-pembelian'))
                    <li><a href="{{ url('backend/laporan-pembelian') }}" class="dropdown-item">Laporan Pembelian</a>
                    </li>
                @endif

                @if (auth()->user()->can('view-laporan-detail-pembelian'))
                    <li><a href="{{ url('backend/laporan-detail-pembelian') }}" class="dropdown-item">Laporan Detail
                            Pembelian</a>
                    </li>
                    <div class="dropdown-divider"></div>
                @endif
                ...
                @if (auth()->user()->can('view-laporan-laba-rugi'))
                    <li><a href="{{ url('backend/laporan-laba-rugi') }}" class="dropdown-item">Laporan Laba Rugi</a>
                    </li>
                @endif
                ...
                @if (auth()->user()->can('view-laporan-nilai-barang'))
                    <div class="dropdown-divider"></div>
                    <li>
                        <a href="{{ url('backend/laporan-nilai-barang') }}" class="dropdown-item">Laporan Nilai
                            Barang</a>
                    </li>
                @endif
            </ul>
        ...
        <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu2" class="dropdown-menu border-0 shadow">
                ...
                @if (auth()->user()->can('view-transaksi-lain') ||
                        ...
                        auth()->user()->can('edit-transaksi-lain') ||
                        auth()->user()->can('delete-transaksi-lain'))
                    <li><a href="{{ url('backend/transaksi-lain') }}" class="dropdown-item">Pengeluaran / Pemasukan
                            Lainnya</a>
                    </li>
                @endif
