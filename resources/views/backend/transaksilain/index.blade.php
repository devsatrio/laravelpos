                    ...
                    <div id="accordion">
                        <div class="card card-secondary">
                            ...
                            <div id="collapseThree"
                                @if (Request::has('tgl_buat')) class="collapse show" @else class="collapse" @endif
                                                ...
                                                <div class="input-group">
                                                    <select name="status" id="status" class="form-control">
                                                        ...
                                                        <option value="Pemasukan"
                                                            @if (Request::has('status')) @if (Request::get('status') == 'Pemasukan') selected @endif
                                                            @endif>Pemasukan</option>
                                                        <option value="Pengeluaran"
                                                            @if (Request::has('status')) @if (Request::get('status') == 'Pengeluaran') selected @endif
                                                            @endif>Pengeluaran</option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <button class="btn btn-secondary" type="submit"><i
                                                                class="fa fa-search"></i></button>
                                                        <a href="{{ url('/backend/transaksi-lain') }}"
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ url('/backend/transaksi-lain/create') }}">
                                        ...
                                        @foreach ($data as $row)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('/backend/transaksi-lain/' . $row->id . '/edit') }}"
                                                        class="btn btn-sm btn-success"><i class="fa fa-wrench"></i></a>
...
@push('customscripts')
    <script src="{{ asset('customjs/backend/transaksilain.js') }}"></script>
@endpush
