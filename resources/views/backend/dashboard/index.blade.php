            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3 id="jumlah_transaksi">Loading..</h3>
                            <p>Jumlah Transaksi</p>
                        </div>
                        <div class="icon">
                            <i class="fas fa-shopping-cart"></i>
                        </div>
                        <a href="{{ url('/backend/penjualan') }}" class="small-box-footer">More info <i
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3 id="jumlah_pelanggan">Loading..</h3>
                            <p>Jumlah Customer</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3 id="jumlah_supplier">Loading..</h3>
                            <p>Jumlah Supplier</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3 id="jumlah_barang">Loading..</h3>
                            <p>Jumlah Barang</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-md-8">
                    <div class="card card-info">
                        <div class="overlay dark loading-grafik">
                ...
                <div class="col-md-4">
                    <div class="card card-info">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Kategori Barang Terlaris {{ date('Y') }}</h3>
                        </div>
                        <div class="card-body">
                            <canvas id="pieChart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                        ...
                        <div class="col-md-12">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" id="jumlah_stok_menipis">Loading...</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" id="jumlah_semua_hutang">Loading...</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" id="jumlah_semua_piutang">Loading...</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('customscripts')
    <script>
        ...
        function get_jumlah_data() {
            $.ajax({
                type: 'GET',
                // url: '/backend/home/get-jumlah',
                url: '/laravelpos/backend/home/get-jumlah',
                success: function(data) {
                    $('#jumlah_transaksi').html(data.jumlahtransaksi);
                    $('#jumlah_pelanggan').html(data.jumlahpelanggan);
                    $('#jumlah_supplier').html(data.jumlahsupplier);
                    $('#jumlah_barang').html(data.jumlahbarang);
                    $('#jumlah_stok_menipis').html(data.barangstokmenipis);
                    $('#jumlah_semua_hutang').html(data.jumlahhutang);
                    $('#jumlah_semua_piutang').html(data.jumlahpiutang);
                },
                complete: function() {}
            });
        }
        ...
        //-------------------------------------------------------------------------------------------------------------------------------
        function get_jumlah_grafik() {
            $.ajax({
                type: 'GET',
                // url: '/backend/home/get-jumlah-grafik',
                url: '/laravelpos/backend/home/get-jumlah-grafik',
                success: function(data) {
                    var areaChartData = {
                        labels: data.linelabelmgn,
                        datasets: [{
                            ...
                            data: [data.linevaluemgn.join("','")]
                        }, ]
                    }
                    var areaChartDataDua = {
                        labels: data.linelabeltahun,
                        datasets: [{
                            label: 'Lunas',
                            ...
                            pointHighlightFill: '#fff',
                            pointHighlightStroke: 'rgba(60,141,188,1)',
                            data: data.linevalbelumlunastahun
                        }, ]
                    }
                    var donutData = {
                        labels: data.nama_kategori,
                        datasets: [{
                            data: data.value_kategori,
                            backgroundColor: data.warna_kategori,
                        }]
                    }
